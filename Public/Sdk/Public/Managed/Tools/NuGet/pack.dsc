...
function createNuSpecFile(metaData: PackageMetadata, deployment: Deployment.Definition, nuSpecOutput: Path, deploymentOptions: Managed.Deployment.FlattenOptions) : { nuspec: File, dependencies: (File|OpaqueDirectory)[] } {
