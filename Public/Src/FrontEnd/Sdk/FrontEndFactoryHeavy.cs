...
namespace BuildXL.FrontEnd.Sdk
{
    ...
    /// </summary>
    public sealed class FrontEndFactoryHeavy
    {
        ...
        /// </summary>
        public static FrontEndFactoryHeavy CreateInstanceForTesting(Func<IConfigurationProcessor> createConfigurationProcessor, params IFrontEnd[] frontEnds)
        {
            Contract.Requires(createConfigurationProcessor != null);
            Contract.Requires(frontEnds != null);

            var factory = new FrontEndFactoryHeavy();
